    ...
    recorrer(){
        ...
        while (aux.siguiente){
            ...
            if(aux.siguiente != this.primero){
                ...
                edges.push({from: aux.id, to: this.primero.id, arrows: "to"})
            }            
            aux = aux.siguiente
...
var listaCirc = new ListaCircular()
...
function crearNodo() {
    ...
    listaCirc.agregarFinal(valueNodo) 
    actualizarTablero()
    console.log("")
    // listaCirc.recorrer()
...
function crearNodoInicio(){
    var valueNodo = document.getElementById('valueNodo').value
    listaCirc.agregarInicio(valueNodo) 
    actualizarTablero()
    console.log("")
    document.getElementById("valueNodo").value = "";
}
...
function focus() {
    var valueNodo = document.getElementById('valueNodo').value
    let nodeId = listaCirc.buscarNodo(valueNodo)
    // console.log(nodeId)
...
function guardarLista(){
    ...
    if (isIE) {
        ...
        a.download = "dataListaCircular.json";
        a.href = link;
