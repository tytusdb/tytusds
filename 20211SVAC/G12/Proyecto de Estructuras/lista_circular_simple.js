...
async function insertar_nodo(){
    ...
    if(dato === ''){
        ...
        if(checkbox == true){
            lista_circular_simple.insertar(dato);
...
async function eliminar_nodo(){
    ...
    var tamaño = 0
    var encontrado = false;
    lista_circular_simple.eliminar(eliminar_dato);
    if(eliminar_dato === ''){
        alert("Por favor ingrese un dato");
        return false;
    }else{
...
async function actualizar_nodo(){
    ...
    lista_circular_simple.actualizar(dato_viejo, dato_nuevo);
...
async function buscar(){
    ...
    var encontrado = false;
    var tamaño = 0;
    lista_circular_simple.buscar(buscar_dato);
        ...
        reader.onload = async function(e){
            ...
            for(var i=0; i<(mydata.valores).length; i++){
                if(mydata.repeticion == true){
                    ...
                    lista_circular_simple.insertar(valores);
                    let node = document.createElement('div');
                    node.classList.add('node');
...
function DescargarArchivo(){
    ...
    var formato = "lista_circular_simple"+"_"+dd+"_"+mm+"_"+yyyy+"_"+HH+"_"+MM;
