...
class CompuestaSimple {
    ...
    llenarN(nodos, contador, relaciones){
        ...
        while(nodo !== null){
            ...
            relaciones.push({from: contador, to: 0+"l"+contador, arrows: "to"})
    ...
    llenarR(relaciones, contador){
        ...
        if(nodo !== null){
            do{
                relaciones.push({from: contador, to: contador+1, arrows: "to"})
                contador++
                nodo = nodo.siguiente
            }while(nodo !== null)
        }
        relaciones.push({from: contador+1, to: contador, arrows: "to"})
        return relaciones
    }
...
export default CompuestaSimple